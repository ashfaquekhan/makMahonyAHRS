...
#define MPU6050_AXOFFSET -46
#define MPU6050_AYOFFSET 49
#define MPU6050_AZOFFSET -545
...
#define MPU6050_GXOFFSET 751
#define MPU6050_GYOFFSET 9
#define MPU6050_GZOFFSET -10
...
class MAKMAHONY{
public:
  void MAKMAHONY_begin();
  void Serial_roll_pitch_yaw(float &r, float &p, float &y);
  void MPU6050_Init();
